...
const CtaSection = () => {
    ...
    return (
        <div className="max-w-7xl bg-zinc-950 bg-gradient-to-br from-zinc-950 to-zinc-900 text-white shadow-lg border-t-[2px] border-t-zinc-500/30 hover:brightness-110 px-12 py-8 mx-4 md:mx-auto rounded-2xl flex flex-col gap-6 text-center mt-16 justify-between">
